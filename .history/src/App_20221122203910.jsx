    ...
    <Container className="App" id='uuid'>
      <First id='content1'>
        ...
        <Leftside id='uuid'>
          ...
          <Description id='uuid'>Sou aficionado por tecnologio e atualmente com habilidades no Front-End/Web, com as Tecnologias JavaScript e React Js. O foco a longo prazo é me tornar FullStack JavaScript, aprendendo Node.js e demais tecnologias correlatas.</Description>
        </Leftside>
      ...
      <Middle id='content2' >
        ...
        <Aside2 id="projects">
          ...
          <Project id='uuid'>
            ...
            <Boxproject id='uuid'>
              <a id='uuid' target="_blank" href='https://qrgenerator.odilolalmeida.tech/'><Projectimg src='./screenview'/></a>
      ...
      <Footer id='uuid'>
        <Contact id='uuid'>
          <Subtitle id='footer'>Minhas redes</Subtitle>
            ...
            <Social id='uuid' target='_blank' href='https://github.com/odiloalmeida'><SocialDiv>
              ...
              <Skillscontent>GitHub</Skillscontent>   
            </SocialDiv></Social>
            ...
            <Social id='uuid' target='_blank' href='https://www.instagram.com/odilolalmeida/'><SocialDiv>
              ...
              <Skillscontent>Instagram</Skillscontent>
            </SocialDiv></Social>
        ...
        <Form id='uuid' action="https://formsubmit.co/odilolima@hotmail.com" method="POST">Entre em contato comigo:
          ...
          <input id='uuid' type="hidden" name="_next" value="https://github.com/odiloalmeida/portfolio/blob/master/src/assets/e-mail.png?raw=true" />
